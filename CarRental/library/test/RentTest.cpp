...
BOOST_FIXTURE_TEST_SUITE(TestSuiteRent, C)
    ...
    {
        Rent *r = new Rent(testID, testClient, testVehicle, testDefaultTime);
    ...
    BOOST_AUTO_TEST_CASE(EndRentTestSetCurrentTime)
    {
        ...
        Rent *r2 = new Rent(testID, testClient, testVehicle, testBeginTime);
    ...
    {
        Rent *r = new Rent(testID, testClient, testVehicle, testEndTime);
        r->endRent(testBeginTime);
        BOOST_TEST_CHECK(r->getEndTime()==testEndTime);
        delete r;
    }
